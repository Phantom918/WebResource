...
<html>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function(e) { 
    		...
    		$(document).on("change","#cityCompany",function(){
				...
				$.ajax({
					...
					success : function(data) {
						...
						$.each(data.recruitmentDetailList, function(i, temp) {
    		...
    		$(document).on("change","#cityDepartment",function(){
    			var departName = $(this).attr("value");
    			var cityCode = $("#cityCompany").attr("value");
				var recruitId = $("#recruitName").attr("value");
				$.ajax({
					url : "job!getAllByRecruit?recruitmentDetail.compCode=" + cityCode+"&recruitmentDetail.pkAppDem="+recruitId+"&recruitmentDetail.deptName="+departName,
					type : "POST",
					dataType : "JSON",
		...
		function subJobChoiceForm(){
			...
			content = content + "user.applyUnitCode="+cityCode+"&user.applyUnit="+cityName+"&user.applyDept="+deptName+"&user.applyPost="+optionName+"&";
		...
		function commitUserMessage(){
			//检查页面上有没有简历ID
			var resumeId = $("#jobChoice").attr("recruitId");
			//alert("简历ID====="+resumeId);
			window.location.href="job!commitAllMessage?resumeId="+resumeId;
		}
                                ...
                                <div class="row" id="jobChoice" recruitId="">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-7">
                                        	<select name="user.applyUnitCode" class="form-control input-sm" id="cityCompany">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-7">
                                        	<input name="user.socialNo" type="text" class="form-control input-sm col-md-10 col-sm-10 col-xs-12" />
                                        </div>
                                    </div><!-- end off "col-md-4 col-sm-4 col-xs-4" -->
          ...
          <div class="modal-dialog">
            <div class="modal-content ">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" onclick="commitUserMessage();" >确定</button>
              </div>
